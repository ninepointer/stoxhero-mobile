...
class AppUrls {
  ...
  static String virtualPendingStopLoss(String id) => "$apiURL/pendingorder/my/todaysPending/$id/paperTrade";
  static String contestPendingStopLoss(String id) => "$apiURL/pendingorder/my/todaysPending/$id/Daily%20Contest";
  static String collegeContestPendingStopLoss(String id) => "$apiURL/pendingorder/my/todaysPending/$id/Daily%20Contest";
  static String marginXPendingStopLoss(String id) => "$apiURL/pendingorder/my/todaysPending/$id/MarginX";
  static String tenXPendingStopLoss(String id) => "$apiURL/pendingorder/my/todaysPending/$id/TenX%20Trader";
  static String internshipPendingStopLoss(String id) => "$apiURL/pendingorder/my/todaysPending/$id/Internship%20Trader";
  ...
  static const String contestChampionList = "$apiURL/dailycontest/lastpaidcontestchampions";
  ...
  static String tenXSubscribePNL(String? subscriptionId, String? subscribedOnTime) =>
  ...
  static String internshipBatchLeaderBoard(String? id) => "$apiURL/internship/leaderboard/$id";
  ...
  static const String weeklyTopPerformersFullListCarouseal = "$apiURL/toptestzoneportfolios";
  static String contestResultPage(String? id) => "$apiURL/dailycontest/trade/$id/result";

  static String getAffiliateSummary = "$apiURL/affiliate/mysummery";
  static String getMyAffiliateReferrals = "$apiURL/affiliate/myaffiliaterafferals";
  static String getMyAffiliateTransactionList = "$apiURL/affiliate/mytransactions";
}
