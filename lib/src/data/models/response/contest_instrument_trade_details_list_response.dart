class ContestInstrumentTradeDetailsListResponse {
  List<ContestInstrumentTradeDetails>? data;

  ContestInstrumentTradeDetailsListResponse({this.data});

  ContestInstrumentTradeDetailsListResponse.fromJson(List? json) {
    if (json != null) {
      data = <ContestInstrumentTradeDetails>[];
      data = json.map((data) => ContestInstrumentTradeDetails.fromJson(data)).toList();
    }
  }
}

class ContestInstrumentTradeDetails {
  bool? tradable;
  String? mode;
  int? instrumentToken;
  num? lastPrice;
  ...
  ContestInstrumentTradeDetails.fromJson(Map<String, dynamic> json) {
