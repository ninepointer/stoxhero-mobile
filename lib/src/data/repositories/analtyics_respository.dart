...
class AnalyticsRepository extends BaseRepository {
  ...
  Future<RepoResponse<AnalyticsDateWiseDetailsResponse>>
      getVirtualTradingDateWiseAnalyticsDetails(
  ...
  Future<RepoResponse<AnalyticsDateWiseDetailsResponse>>
      getTenxTradingDateWiseAnalyticsDetails(
    Map<String, dynamic> query,
  ) async {
  ...
  Future<RepoResponse<AnalyticsDateWiseDetailsResponse>>
      getInfinityTradingDateWiseAnalyticsDetails(
    Map<String, dynamic> query,
  ) async {
  ...
  Future<RepoResponse<AnalyticsExpectedPnLOverviewDetailsResponse>>
    ...
    return response is APIException
        ...
        : RepoResponse(
            data:
                AnalyticsExpectedPnLOverviewDetailsResponse.fromJson(response));
  }
