...
class InternshipRespository extends BaseRepository {
  Future<RepoResponse<AnalyticsOverviewDetailsResponse>>
      getInternshipAnalyticsOverview(String? id) async {
  ...
  Future<RepoResponse<AnalyticsMonthlyPnLOverviewDetailsResponse>>
    ...
    return response is APIException
        ...
        : RepoResponse(
            data:
                AnalyticsMonthlyPnLOverviewDetailsResponse.fromJson(response));
  }

  Future<RepoResponse<InternshipBatchResponse>>
      getInternshipBatchDetails() async {
  ...
  Future<RepoResponse<InternshipBatchPortfolioResponse>>
      getInternshipBatchPortfolioDetails(String? id) async {
    ...
    return response is APIException
        ? RepoResponse(error: response)
        : RepoResponse(
            data: InternshipBatchPortfolioResponse.fromJson(response));
  }

  Future<RepoResponse<InternshipLeaderBoardResponse>>
      getInternshipBatchLeaderBoard(String? id) async {
    String apiURL = AppUrls.internshipBatchLeaderBoard(id);
    var response = await service.getAuth(path: apiURL);
    return response is APIException
        ? RepoResponse(error: response)
        : RepoResponse(data: InternshipLeaderBoardResponse.fromJson(response));
  }
  ...
  Future<RepoResponse<GenericResponse>> placeOrder(
  ...
  Future<RepoResponse<TradingPositionListResponse>> getInternshipPositions(
      String? id) async {
  ...
  Future<RepoResponse<InternshipOrdersListResponse>>
      getInternshipAllOrdersList() async {
  ...
  Future<RepoResponse<InternshipOrdersListResponse>>
      getInternshipTodayOrdersList() async {
  ...
  Future<RepoResponse<InternshipCertificateResponse>>
      getInternshipCertificate() async {
