...
class TenxTradingRepository extends BaseRepository {
  ...
  Future<RepoResponse<TenxActivePlanListResponse>>
      getTenxActiveSubscriptions() async {
  ...
  Future<RepoResponse<TradingPositionListResponse>> getTenxPositions(
      String id) async {
  ...
  Future<RepoResponse<TenxTradingPortfolioDetailsResponse>>
      getTenxPortfolioDetails(String subId) async {
    String apiURL = '${AppUrls.tenx}/$subId/trade/marginDetail';
    var response = await service.getAuth(path: apiURL);
    return response is APIException
        ? RepoResponse(error: response)
        : RepoResponse(
            data: TenxTradingPortfolioDetailsResponse.fromJson(response));
  }

  Future<RepoResponse<GenericResponse>> placeTenxTradingOrder(
      Map<String, dynamic> data) async {
  ...
  Future<RepoResponse<GenericResponse>> purchaseSubscription(
      Map<String, dynamic> data) async {
  ...
  Future<RepoResponse<CountTradingDaysResponse>> getTenxCountTradingDays(
      String id) async {
  ...
  Future<RepoResponse<TenxSubscribedPlanPNLResponse>>
      getTenxMyActiveSubscribedPNL(
          String? subscriptionId, String? subscribedOnTime) async {
    String apiURL = AppUrls.tenXSubscribePNL(subscriptionId, subscribedOnTime);
    var response = await service.getAuth(path: apiURL);
    return response is APIException
        ? RepoResponse(error: response)
        : RepoResponse(data: TenxSubscribedPlanPNLResponse.fromJson(response));
  }

  Future<RepoResponse<TenxSubscriberCountListResponse>> getTenxSubcriberCount(
      String? id) async {
    ...
    return response is APIException
        ? RepoResponse(error: response)
        : RepoResponse(
            data: TenxSubscriberCountListResponse.fromJson(response));
  }

  Future<RepoResponse<TenxSubscribedPlanListResponse>>
      getTenxMyActiveSubscribed() async {
  ...
  Future<RepoResponse<TenxExpiredPlanListResponse>>
      getTenxMyExpiredSubscription() async {
  ...
  Future<RepoResponse<GenericResponse>> tenxRenewSubscription(
      Map<String, dynamic> data) async {
  ...
  Future<RepoResponse<GenericResponse>> tenxTutorial(
      Map<String, dynamic> data) async {
