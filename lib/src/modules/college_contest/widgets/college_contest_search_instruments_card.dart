...
class CollegeContestSearchInstrumentsCard extends GetView<CollegeContestController> {
  final TradingInstrument tradingInstrument;
  final bool isAdded;

  const CollegeContestSearchInstrumentsCard({
    super.key,
        ...
        Row(
          children: [
            ...
            Expanded(
              child: GestureDetector(
                onTap: isAdded
                    ? () => Get.find<CollegeContestController>().removeInstrument(tradingInstrument.instrumentToken)
                    : () => Get.find<CollegeContestController>().addInstrument(tradingInstrument),
                child: Container(
                  alignment: Alignment.center,
                  padding: EdgeInsets.all(12),
                  decoration: BoxDecoration(
