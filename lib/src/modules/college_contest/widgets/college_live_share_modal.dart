...
class CollegeLiveShareModalContent extends GetView<CollegeContestController> {
  final LiveCollegeContest? contest;
  const CollegeLiveShareModalContent({
    this.contest,
    Key? key,
  }) : super(key: key);
