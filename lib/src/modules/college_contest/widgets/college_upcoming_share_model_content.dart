...
class CollegeUpComingShareModalContent
    extends GetView<CollegeContestController> {
  final UpComingCollegeContest? contest;
  const CollegeUpComingShareModalContent({
    this.contest,
    Key? key,
  }) : super(key: key);
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  controller.upComingCollegeContest.value
                                              .rewardType !=
                                          "Goodies"
                                      ? Text(
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          (controller.upComingCollegeContest
                                                      .value.rewardType !=
                                                  "Goodies")
                                              ? Text(
