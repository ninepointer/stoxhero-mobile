        ...
        child: Column(
          children: [
            ...
            customCard(
              ...
              onPressed: () {
                Get.find<ContestController>().getCompletedCollegeContestList();
            ...
            customCard(
              ...
              onPressed: () {
                Get.find<ContestController>().getContestLeaderboardList();
                Get.find<ContestController>().getCollegeContestLeaderboardList();
