        ...
        () => Visibility(
          ...
          replacement: ListView.builder(
            ...
            itemBuilder: (BuildContext context, index) {
              ...
              //condition for showing list where user total payout is grater then zero
              if (controller.weeklyTopPerformerFullList[index].totalPayout! >=
                  1) {
                return CommonCard(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              CommonFilledButton(
                                ...
                                onPressed: () {
                                  controller
                                      .getContestProfileData(weekly.trader);
