...
class WorkshopBatchNameWidget extends GetView<CourseController> {
  final InfluencerCourseData? courseData;

  WorkshopBatchNameWidget(this.courseData);
        ...
        child: Column(
          children: [
            if (isStudent) ...{
              ...
              //     Flexible(
              //       child: Text(
              //         "Access to free StoxHero trading simulator along with this workshop",
