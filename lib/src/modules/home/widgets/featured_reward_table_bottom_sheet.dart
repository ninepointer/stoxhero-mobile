...
class FeaturedRewardTableBottomSheet extends StatelessWidget {
  final LiveFeatured? liveContest;
  final UpcomingFeatured? upcomingContest;
  FeaturedRewardTableBottomSheet({
    this.liveContest,
            ...
            if (liveContest != null || upcomingContest != null)
              Table(
                ...
                children: [
                  ...
                  if (liveContest != null)
                    for (FeaturedRewards reward in liveContest!.rewards ?? [])
                      TableRow(
                        children: [
                          TableCell(
                            child: Container(
