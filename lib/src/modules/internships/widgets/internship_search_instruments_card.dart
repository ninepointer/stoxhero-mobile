...
class InternshipSearchInstrumentsCard extends GetView<InternshipController> {
  final TradingInstrument tradingInstrument;
  final bool isAdded;

  const InternshipSearchInstrumentsCard({
    super.key,
        ...
        Row(
          children: [
            ...
            Expanded(
              child: GestureDetector(
                onTap: isAdded
                    ? () => Get.find<InternshipController>().removeInstrument(tradingInstrument.instrumentToken)
