...
class Story41 extends StatefulWidget {
  const Story41({Key? key}) : super(key: key);

  @override
  _Story41State createState() => _Story41State();
}

class _Story41State extends State<Story41> with SingleTickerProviderStateMixin {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10.0),
                          Text(
                            "Participants tested their strategies in TestZones",
                            style: TextStyle(
                              fontSize: 24.0,
                              fontFamily: 'Sans-serif',
                              fontWeight: FontWeight.bold,
                          ...
                          SizedBox(height: 10.0),
                          Text(
                            "Traders subscribed to our TenX plans",
                            style: TextStyle(
                              fontSize: 24.0,
                              fontFamily: 'Sans-serif',
                              fontWeight: FontWeight.bold,
