...
class Story74 extends StatefulWidget {
  const Story74({Key? key}) : super(key: key);

  @override
  _Story41State createState() => _Story41State();
}

class _Story41State extends State<Story74> with SingleTickerProviderStateMixin {
