...
class ShareTenXModalContent extends GetView<TenxTradingController> {
  final TenxExpiredPlan subscription;
  const ShareTenXModalContent({
    Key? key,
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        ...
                                        Text(
                                            '${FormatHelper.formatNumbers(subscription.fee, decimal: 0)}',
                                            style: AppStyles.tsSecondaryMedium16
                                                .copyWith(
                                                    color: AppColors.white))
                                      ],
